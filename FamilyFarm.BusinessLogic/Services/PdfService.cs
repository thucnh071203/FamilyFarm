...
namespace FamilyFarm.BusinessLogic.Services
{
    public class PdfService : IPdfService
    {
        ...
        //        //    {
        //        //        page.Margin(40);
        //        //        page.Header().Text($"Invoice: {data.PaymentId}").FontSize(20).Bold().AlignCenter();
        //        //        page.Content().Column(col =>
        //        //        {
        //        //            col.Item().Text($"Service: {data.ServiceName}");
        //        //            col.Item().Text($"Category: {data.CategoryServiceName}");
        //        //            col.Item().Text($"Expert: {data.ExpertName}");
        //        //            col.Item().Text($"Farmer: {data.FarmerName}");
        //        //            col.Item().Text($"Payer: {data.PayerName}");
        //        //            col.Item().Text($"Book date: {data.BookingServiceAt?.ToString("dd/MM/yyyy")}");
        //        //            col.Item().Text($"Paid at: {data.PayAt?.ToString("dd/MM/yyyy")}");
        //        //            col.Item().Text($"Total: {data.Price:N0} VND");
        //        //        });
        //        //        page.Footer().AlignCenter().Text("Family Farm - Thank you!");
        //        //    });
        //        //});
        //        var doc = Document.Create(container =>
        //        {
        ...
        //                    row.ConstantColumn(200).AlignRight().Background(Colors.Green.Medium).PaddingVertical(5).Text("Paid").FontSize(16).FontColor(Colors.White).Bold().AlignCenter();
        //                });
        ...
        //                    page.Footer().AlignCenter().Text("Family Farm - Thank you!").FontSize(12).FontColor(Colors.Grey.Darken2);
        //                });
        //            });
